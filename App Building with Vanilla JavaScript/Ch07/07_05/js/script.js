...
(function() {
	...
	const apiKey = "3a0aa2e64629f9597af6c171915d48bf"; // Replace "APIKEY" with your own API key; otherwise, your HTTP request will not work
	const activities = {
...
*/
		...
		conditionsPara.textContent = `${state.degCInt}\u00Bo C / ${state.degFInt}\u00B0 F`;
